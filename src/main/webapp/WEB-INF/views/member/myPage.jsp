      ...
      <table id="myInfoTable">
         ...
         <tr>
            <td colspan="2" align="center">               
               <button type="button" onclick="location.href='mpwdUpdateView.do'">비밀번호수정</button>
               <button type="button" onclick="location.href='mupdateView.do'">정보수정</button>
               <c:url var="mdelete" value="mdelete.do">
                  <c:param name="id" value="${ loginUser.id }"/><!-- 넘어갈 값이 있으니 param을 넣게 c:url을 쓰자 -->
               </c:url>
               <button type="button" onclick="deleteCheck();">회원탈퇴</button>
